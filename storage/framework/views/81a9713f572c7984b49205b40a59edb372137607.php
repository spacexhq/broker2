            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <h1><?php echo e($settings->currency); ?><?php echo e(number_format($amount)); ?></h1>
                        </div>
                    </div>
                    <!-- Title -->
                    <h3 class="card-title mt-3 mb-0 text-dark"><?php echo e($payment_mode->name); ?></h3>
                    <span class="text-muted m-0 p-0"><?php echo e($payment_mode->name); ?></span>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="card-body">
                                <?php if($title != 'Complete Payment'): ?>
                                    ...
                                    <div>
                                        ...
                                        <h4>
                                        <?php if(!empty($payment_mode->barcode)): ?>
                                        
                                        <img src="<?php echo e($payment_mode->barcode); ?>" alt="" class="w-25">
                                            <?php endif; ?>
                                        </h4>
                                    </div>
...
} elseif ($_instance->childHasBeenRendered('UszYkYu')) {
    $componentId = $_instance->getRenderedChildComponentId('UszYkYu');
    $componentTag = $_instance->getRenderedChildComponentTagName('UszYkYu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('UszYkYu');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-payment', []);
    $html = $response->html();
    $_instance->logRenderedChild('UszYkYu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                <?php else: ?>
                                                ...
                                                <div class="mb-3 form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control readonly"
                                                            value="<?php echo e($payment_mode->wallet_address); ?>" id="myInput" 
                                                            readonly>
...
<?php echo $__env->make('layouts.dashly1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/itihycia/public_html/trade/resources/views/user/payment.blade.php ENDPATH**/ ?>