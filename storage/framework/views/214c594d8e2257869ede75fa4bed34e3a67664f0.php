                    ...
                    <div class="col-12">
                        <di>
                            <a class='btn btn-primary' href='https://t.me/+VRumJJSKKGdjM2I0'>
                                Join our Telegram channel for More scripts/help
                            </a>
                        </di>
...
} elseif ($_instance->childHasBeenRendered('kbumA90')) {
    $componentId = $_instance->getRenderedChildComponentId('kbumA90');
    $componentTag = $_instance->getRenderedChildComponentTagName('kbumA90');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('kbumA90');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('kbumA90', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/itihycia/public_html/trade/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>