    ...
    <div class="page-title">
        <div class="row justify-content-between align-items-center">
            <div class="mb-3 col-md-6 mb-md-0">
                <h5 class="h2 m-0">Account Settings</h5>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.dashly1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\innovatex-broker\resources\views/user/profile.blade.php ENDPATH**/ ?>