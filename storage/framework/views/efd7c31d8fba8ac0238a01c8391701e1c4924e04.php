...
} elseif ($_instance->childHasBeenRendered('rxnicsd')) {
    $componentId = $_instance->getRenderedChildComponentId('rxnicsd');
    $componentTag = $_instance->getRenderedChildComponentTagName('rxnicsd');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('rxnicsd');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('rxnicsd', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH /home/itihycia/public_html/trade/resources/views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>