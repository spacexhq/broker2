    ...
    <div class="page-title">
        <div class="row justify-content-between align-items-center">
            <div class="mb-3 col-md-6 mb-md-0">
                <h1 class="h2 m-0">Your <?php echo e($plan->dplan->name); ?> Plan</h1>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.dashly1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/itihycia/public_html/trade/resources/views/user/plandetails.blade.php ENDPATH**/ ?>