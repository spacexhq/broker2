    ...
    <div class="col-12">
        <form method="post" action="<?php echo e(route('updatewebinfo')); ?>" id="appinfoform" enctype="multipart/form-data">
            ...
            <div class=" form-row">
                ...
                <!--</div>-->
                 <div class="form-group col-md-6">
                    <h5 class="text-<?php echo e($text); ?>">Select User Default Theme</h5>
                    <select name="usertheme" class="form-control  select2">
                        <option>Theme Type</option>
                        <option disabled value="<?php echo e($settings->usertheme); ?>">Current: <?php echo e($settings->usertheme); ?></option>
...
<?php /**PATH /home/itihycia/public_html/trade/resources/views/admin/Settings/AppSettings/webinfo.blade.php ENDPATH**/ ?>