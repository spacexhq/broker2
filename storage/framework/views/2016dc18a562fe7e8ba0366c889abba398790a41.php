                                            ...
                                            <div class="float-right btn-group">
                                                ...
                                                <?php endif; ?>
                                                    ...
                                                    <a href="#" data-toggle="modal" data-target="#topupModal"
                                                        ...
                                                        class="dropdown-item">Set Tax Code for client </a>
                                                        
                                                        <?php if($user->upgrade == 'on'): ?>
                                                        <a class="dropdown-item"
                                                            href="<?php echo e(url('admin/dashboard/upgrade')); ?>/<?php echo e($user->id); ?>/off">Turn
                                                            off Upgrade </a>
                                                    <?php else: ?>
                                                        <a class="dropdown-item"
                                                            href="<?php echo e(url('admin/dashboard/upgrade')); ?>/<?php echo e($user->id); ?>/on">Turn
                                                            on Upgrade</a>
                                                    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/itihycia/public_html/trade/resources/views/admin/Users/userdetails.blade.php ENDPATH**/ ?>