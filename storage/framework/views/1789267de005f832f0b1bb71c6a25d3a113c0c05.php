...
} elseif ($_instance->childHasBeenRendered('0clFAh8')) {
    $componentId = $_instance->getRenderedChildComponentId('0clFAh8');
    $componentTag = $_instance->getRenderedChildComponentTagName('0clFAh8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('0clFAh8');
} else {
    $response = \Livewire\Livewire::mount('user.crypto-payment', []);
    $html = $response->html();
    $_instance->logRenderedChild('0clFAh8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                                <?php else: ?>
...
<?php echo $__env->make('layouts.dashly1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gfzwcacl/public_html/trade/resources/views/user/payment.blade.php ENDPATH**/ ?>