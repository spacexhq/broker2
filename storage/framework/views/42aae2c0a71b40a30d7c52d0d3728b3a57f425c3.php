    ...
    <fieldset>
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" name="account_name" value="<?php echo e(Auth::user()->account_name); ?>" class="form-control "
                    placeholder="Enter Account name">
            </div>
            <div class="form-group col-md-6">
                <label class="">Account Number</label>
                <input type="text" name="account_no" value="<?php echo e(Auth::user()->account_number); ?>" class="form-control "
    ...
    <fieldset class="mt-2">
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" name="btc_address" value="<?php echo e(Auth::user()->btc_address); ?>" class="form-control "
                    placeholder="Enter Bitcoin Address">
                <small class="">Enter your Bitcoin Address that will be used to withdraw your funds</small>
            </div>
            <div class="form-group col-md-6">
                <label class="">Ethereum</label>
                <input type="text" name="eth_address" value="<?php echo e(Auth::user()->eth_address); ?>" class="form-control "
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" name="ltc_address" value="<?php echo e(Auth::user()->ltc_address); ?>" class="form-control "
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" name="usdt_address" value="<?php echo e(Auth::user()->usdt_address); ?>" class="form-control"
...
<?php /**PATH D:\xampp\htdocs\innovatex-broker\resources\views/profile/update-withdrawal-method.blade.php ENDPATH**/ ?>