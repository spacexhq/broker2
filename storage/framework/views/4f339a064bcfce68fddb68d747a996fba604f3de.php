                    ...
                    <div data-accordion="content-container">
                      <div class="accordion__content typography" data-accordion="content">
                        ...
                        <div class="answer-item"> 
                          <div class="answer-item__trigger">WHAT IS <?php echo e($settings->site_name); ?>?                          </div>
                          <div class="answer-item__content typography">
                            <p><?php echo e($settings->site_name); ?> - Professional team of cryptocurrency industry developers. The main advantage of the company is a unique trading bot that makes a profit at the stage of growth and market decline.</p>
                          </div>
                        </div>
                        <!---->
                        <div class="answer-item"> 
                          <div class="answer-item__trigger">IS <?php echo e($settings->site_name); ?> the OFFICIALLY REGISTERED COMPANY?                          </div>
                          <div class="answer-item__content typography">
                    ...
                    <div data-accordion="content-container">
                      <div class="accordion__content typography" data-accordion="content">
                        ...
                        <div class="answer-item"> 
                          ...
                          <div class="answer-item__content typography">
                            <p>Any person who has reached the age of majority in their country of residence can register in <?php echo e($settings->site_name); ?></p>
                          </div>
                        </div>
                        <!---->
                        <div class="answer-item"> 
...
Click the Register button. Enter your details to quickly create a FREE <?php echo e($settings->site_name); ?> account.<br>
2. OPEN A DEPOSIT<br>
                  ...
                  <li class="accordion__item">
                    ...
                    <div data-accordion="content-container">
                      <div class="accordion__content typography" data-accordion="content">
                        <!---->
                        <div class="answer-item"> 
                          <div class="answer-item__trigger">WHAT WAYS TO OBTAIN INCOME IN <?php echo e($settings->site_name); ?> ARE?                          </div>
                          <div class="answer-item__content typography">
                    ...
                    <div data-accordion="content-container">
                      <div class="accordion__content typography" data-accordion="content">
                        ...
                        <div class="answer-item"> 
                          ...
                          <div class="answer-item__content typography">
                            <p><?php echo e($settings->site_name); ?> offers a unique investment and referral program that rewards you not only for partners who came from you to the platform, but also for partners from levels 2,3 and 4. This unique affiliate program brings you passive referral income. First, you earn by inviting friends to <?php echo e($settings->site_name); ?>, and then you earn when people in your structure refer new investors to the company. Affiliate system level: 7% - 3% - 2% - 1%</p>
                          </div>
                        </div>
                        <!---->
                        <div class="answer-item"> 
                          ...
                          <div class="answer-item__content typography">
                            <p>You do not need to apply for participation, own an industry web resource with a large audience of investors or meet other abstract requirements to participate in the referral program. We assign each user a unique referral link immediately after registration, which you can already use to attract other investors, simply by inviting them to the <?php echo e($settings->site_name); ?> website using the referral link.</p>
                          </div>
                        </div>
                        <!---->
                        <div class="answer-item"> 
                    ...
                    <div data-accordion="content-container">
                      <div class="accordion__content typography" data-accordion="content">
                        ...
                        <div class="answer-item"> 
                          ...
                          <div class="answer-item__content typography">
                            <p>Click on the reset password link on the main page of the site in the login section. Enter your username and email address and follow the instructions. You will receive information on how to reset your <?php echo e($settings->site_name); ?> account password.</p>
                          </div>
                        </div>
                        <!---->
                      </div>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/remedycodes/public_html/pro.remedycodes.online/resources/views/home/faq.blade.php ENDPATH**/ ?>