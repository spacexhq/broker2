                    ...
                    <div class="col-12">
                        <div class="mb-4">
                            ...
                            <input type="email" name="email" value="<?php echo e(old('email')); ?>" class="form-control"
                                placeholder="zam Your email address">
...
<?php echo $__env->make('layouts.guest1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\broker2\resources\views/auth/adminlogin.blade.php ENDPATH**/ ?>